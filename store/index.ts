...
interface OrgState {
  ...
  allOrgs: Organization[] | null;
  setAllOrgs: (orgs: Organization[] | null) => void;
}

export const useOrgStore = create<OrgState>((set) => ({
  selectedOrg: null,
  setSelectedOrg: (org) => set((state) => ({ ...state, selectedOrg: org })),
  allOrgs: null,
  setAllOrgs: (orgs) => set((state) => ({ ...state, allOrgs: orgs })),
}));
